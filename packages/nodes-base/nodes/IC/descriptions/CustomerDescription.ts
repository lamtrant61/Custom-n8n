...
export const customerFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		description: 'Customer title. The title can be a maximum of 128 characters long.',
	},
	{
		displayName: 'Start',
		name: 'start',
		...
		description:
			'Date and time for the start of the customer. Acceptable <a href="https://datatracker.ietf.org/doc/html/rfc2445"> format</a>.',
	},
	{
		displayName: 'End',
		name: 'end',
		...
		description:
			'Date and time for the end of the customer. Acceptable <a href="https://datatracker.ietf.org/doc/html/rfc2445"> format</a>.',
	},
	{
		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'Customer agenda. The agenda can be a maximum of 1300 characters long.',
			},
			{
				displayName: 'Allow Any Customer To Be Co-Host',
				name: 'allowAnyCustomerToBeCoHost',
				type: 'boolean',
				default: false,
				description:
		...
		options: [
			{
				...
				default: '',
				description:
					'Email address for the customer host. This parameter is only used if the customer or application calling the API has the admin-level scopes.',
			},
			{
		...
		options: [
			{
				...
				default: '',
				description:
					'Email address for the meeting host. This parameter is only used if the customer or application calling the API has the admin-level scopes.',
			},
			{
				...
				default: '',
				description:
					"Meeting password. It's required when the meeting is protected by a password and the current customer is not privileged to view it if they are not a host, co-host or invitee of the meeting.",
			},
			{
				displayName: 'Send Email',
				name: 'sendEmail',
	...
	},
	{
		...
		options: [
			...
			{
				displayName: 'Allow First Customer To Be Co-Host',
				name: 'allowFirstCustomerToBeCoHost',
				type: 'boolean',
				default: false,
				description:
			...
			},
			{
				...
				default: '',
				description:
					'Email address for the meeting host. This attribute should only be set if the customer or application calling the API has the admin-level scopes.',
			},
			{
				displayName: 'Invitees',
				name: 'inviteesUi',
			...
			},
			{
				...
				default: '',
				description:
					'URL of the Webex site which the meeting is created on. If not specified, the meeting is created on customer\'s preferred site. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Start',
				name: 'start',
